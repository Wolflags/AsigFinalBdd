...
public class Modificar extends JDialog {
	...
	private JComboBox cbxCategoriaPago;
	...
	public Modificar(String id) {
		...
		((JTextField) txtCarrera).setColumns(10);
		...
		txtFechaNacimiento.setColumns(10);
		{
			...
			btnNewButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					updateEstudiante(txtId, txtNombre1, txtNombre2, txtApellido1, txtApellido2, txtCarrera, txtNacionalidad, txtDireccion, txtFechaNacimiento, null);
					JOptionPane.showMessageDialog(null, "Los datos se modificaron correctamente", "Éxito", JOptionPane.INFORMATION_MESSAGE);
					dispose();
	...
	public void updateEstudiante(JTextField paraid, JTextField paranom1, JTextField paranom2, JTextField paraape1, JTextField paraape2, JTextField paracarr, JTextField paracate, JTextField paranaci, JTextField paradire, JTextField parafecha) {
	    Connection con = ConexionDB.getConnection();

	   if(con != null) {
	           
	        try {
	            String sql = "UPDATE Estudiante SET Nombre1=?, Nombre2=?, Apellido1 = ?, Apellido2 = ?, Carrera = ?, Nacionalidad = ?, CategoriaPago = ?, FechaNacimiento = ? WHERE Id = ?";

	        	 PreparedStatement ps = con.prepareStatement(sql);
	        	 ps.setString(1, paraid.getText());
	        	 ps.setString(2, paranom1.getText());
	        	 ps.setString(3, paranom2.getText());
	        	 ps.setString(4, paraape1.getText());
	        	 ps.setString(5, paraape2.getText());
	        	 ps.setString(6, paracarr.getText());
	        	 ps.setString(7, paracate.getText());
	        	 ps.setString(8, paranaci.getText());
	        	 ps.setString(9, paradire.getText());
	        	 ps.setString(10, parafecha.getText());
	        	 ps.executeUpdate();
